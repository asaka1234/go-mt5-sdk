...
type MTOrder struct {
	...
	ActivationMode uint    `json:"activation_mode"  msgpack:"activation_mode"` //激活模式  //0-none, 1=ACTIVATION_PENDING, 2=ACTIVATION_STOPLIMIT,3=ACTIVATION_EXPIRATION,4=ACTIVATION_STOPOUT
